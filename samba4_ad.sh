...
if [ $# -eq 0 ]
  then
        echo "No arguments supplied, nothing to do!"
	      echo "Es: ./samba4_ad.sh doJson"
        echo "Es. ./samba4_ad.sh getJsonStatus"
        echo "Es. ./samba4_ad.sh getErrorFrom"
        echo "Es. ./samba4_ad.sh getErrorTo"
        echo "Es. ./samba4_ad.sh getFromErrorDetails"
        echo "Es. ./samba4_ad.sh getToErrorDetails"
        echo "Es. ./samba4_ad.sh getProcessCount"
        echo "Es: ./samba4_ad.sh doDbCheck"
        echo "Es. ./samba4_ad.sh getDbStatus"
        echo "Es. ./samba4_ad.sh getNTDSConnections"
	exit 1
fi
